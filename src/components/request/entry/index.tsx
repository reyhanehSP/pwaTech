          ...
          >
            ...
            <g clipPath="url(#clip0_511_3499)">
              <rect
                ...
                height="72.0045"
                rx="16"
                transform="matrix(0.956347 0.292232 -0.292626 0.956227 131.097 33)"
                fill="#F1F0FE"
              />
              <g clipPath="url(#clip1_511_3499)">
                ...
                <rect
                  ...
                  height="2"
                  rx="0.2"
                  transform="rotate(17.0034 150.017 59.7285)"
                  fill="#ECA323"
                />
                <path
                  d="M141.513 73.8594L168.289 82.0474"
                  stroke="#ECA323"
                  strokeWidth="2"
                />
                <rect
                  ...
                  height="2"
                  rx="0.2"
                  transform="rotate(-72.9966 163.722 76.4688)"
                  fill="#ECA323"
                />
                <rect
                  x="160.212"
                  ...
                  height="2"
                  rx="0.2"
                  transform="rotate(-72.9966 160.212 87.9434)"
                  fill="#ECA323"
                />
              </g>
            </g>
            <rect
              ...
              height="70.0045"
              rx="15"
              transform="matrix(0.956347 0.292232 -0.292626 0.956227 131.491 32.8607)"
              stroke="white"
              strokeWidth="2"
            />
            <g clipPath="url(#clip2_511_3499)">
              <rect
                ...
                height="72.0052"
                rx="16"
                transform="matrix(0.949417 -0.314019 0.314437 0.949278 0 70)"
                fill="#F9E2BB"
              />
              <g clipPath="url(#clip3_511_3499)">
                ...
                <rect
                  ...
                  height="2.00004"
                  rx="0.2"
                  transform="rotate(-18.3142 26.2129 85.5508)"
                  fill="#ECA323"
                />
                <rect
                  x="28.4395"
                  ...
                  height="2"
                  rx="0.2"
                  transform="rotate(71.6858 28.4395 79.5469)"
                  fill="#ECA323"
                />
                <rect
                  x="32.2363"
                  ...
                  height="2"
                  rx="0.2"
                  transform="rotate(71.6858 32.2363 78.2891)"
                  fill="#ECA323"
                />
                <rect
                  x="36.0352"
                  ...
                  height="2"
                  rx="0.2"
                  transform="rotate(71.6858 36.0352 77.0332)"
                  fill="#ECA323"
                />
                <rect
                  x="52.4883"
                  ...
                  height="8"
                  rx="0.2"
                  transform="rotate(71.6858 52.4883 72.6406)"
                  fill="#ECA323"
                />
                <circle
                  cx="46.7451"
                  cy="96.6617"
                  r="10"
                  transform="rotate(-18.3142 46.7451 96.6617)"
                  stroke="#ECA323"
                  strokeWidth="2"
                />
                <circle
                  ...
                  cy="96.6623"
                  r="6"
                  transform="rotate(-18.3142 46.7455 96.6623)"
                  fill="#ECA323"
                  stroke="#ECA323"
                  strokeWidth="2"
                />
            ...
            <rect
              ...
              height="70.0052"
              rx="15"
              transform="matrix(0.949417 -0.314019 0.314437 0.949278 -0.135819 70.4291)"
              stroke="white"
              strokeWidth="2"
            />
            <rect
              ...
              height="70.0029"
              rx="15"
              transform="matrix(0.972204 0.234136 -0.234462 0.972125 75.359 78.8609)"
              fill="#E4E7EC"
            />
            <rect
              x="0.737741"
            ...
            <g clipPath="url(#clip4_511_3499)">
              ...
              <ellipse
                ...
                rx="3"
                ry="3"
                transform="rotate(13.5503 89.4978 129.812)"
                fill="#ECA323"
                stroke="#ECA323"
                strokeWidth="2"
              />
              ...
              <rect
                ...
                height="8"
                rx="0.2"
                transform="rotate(103.55 97.5693 109.126)"
                fill="#ECA323"
              />
            </g>
            <defs>
        ...
        >
          ...
          <foreignObject x="0" y="0" width="100%" height="100%">
            <div className={style.contentWrapper}>
              <button className={style.contentText}>
                {currStep === 1 ? "ثبت نام و ورود" : "احراز هویت"}
              </button>
              {currStep === 1 ? (
                  ...
                  <div>
                    ...
                    >
                      <CheckBox
                        ...
                        onChange={(e: any) =>
                          handleChangeRule(e.target.checked)
                        }
                      />
                    </Link>
                  </div>
                ...
                <div className={style.verifyCodeWrapper}>
                  <p className={style.title}>
                    لطفا کد ارسال شده به شماره موبایل {phoneNumber} را وارد
                    نمایید.
                    <span
                      className={style.changePhoneNumber}
                  ...
                  <AppButtonNew
                    ...
                    iconUrl={
                      enteredPhoneNumber
                        ...
                        : "/assets/icons/arrowRightDisable/icon.svg"
                    }
                    text={"بعدی"}
                  />
                ) : (
